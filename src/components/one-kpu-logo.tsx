...
interface OneKpuLogoProps extends LucideProps {
  disableName?: boolean;
}

export default function OneKpuLogo({ disableName, ...props }: OneKpuLogoProps) {
  const width = disableName ? "32" : "148";
  return (
    <svg
      ...
      height="39"
      fill="none"
      viewBox={`0 0 ${width} 39`}
      className="text-black dark:text-white"
      {...props}
    >
      <g clipPath="url(#clip0_277_251)">
        <g clipPath="url(#clip1_277_251)">
          <path
            fill="#8C2332"
      ...
      <defs>
        <clipPath id="clip0_277_251">
          <path fill="currentColor" d="M0 0H148V39H0z"></path>
        </clipPath>
